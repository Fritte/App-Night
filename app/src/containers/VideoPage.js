...
class VideoPage extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    //console.log('videoPage::shouldCompUpdate => shouldUpdate : %s', nextProps.shouldUpdate);
    //return false;
    //return nextProps.shouldUpdate;
    //return true || !Math.round(nextProps.trans);
...
//ReactMixin.onClass(VideoPage, PureRenderMixin);
