...
class ProfileEditImagePage extends Component {
  constructor(props) {
    super(props);
...
ProfileEditImagePage.propTypes = {
};
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileEditImagePage);
