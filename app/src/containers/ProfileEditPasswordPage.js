...
class ProfileEditPasswordPage extends Component {
  constructor(props) {
    super(props);
...
ProfileEditPasswordPage.propTypes = {
};
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileEditPasswordPage);
